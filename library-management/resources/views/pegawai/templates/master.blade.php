...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto" style="background-color: #e7effe;">
        ...
        <ul class="space-y-6 font-medium mt-14">
            <li>
                <a href="{{ route('employee.dashboard') }}" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-white group">
            ...
            <li>
                <a href="{{ route('employee.book.index') }}" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-white group">
                    <i class="fas fa-book" style="color: #88a5c3; font-size: 26px; transition: color 0.3s;"></i>
                    <span class="ms-5 text-md font-bold">Book</span>
                </a>
            </li>
            <li>
                <a href="{{ route('employee.loan.index') }}" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-white group">
            ...
            <li>
                <a href="{{ route('employee.return.index') }}" class="flex items-center p-2 text-gray-600 rounded-lg hover:bg-white group">
                    <i class="fas fa-history" style="color: #88a5c3; font-size: 26px; transition: color 0.3s;"></i>
                    <span class="ms-5 text-md font-bold">Return</span>
                </a>
            </li>
        </ul>
